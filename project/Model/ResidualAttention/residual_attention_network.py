...
class ResidualAttentionModel_92_32input(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv3d(3, 32, kernel_size=5, stride=1, padding=2, bias=False),
            nn.BatchNorm3d(32),
            nn.ReLU(inplace=True)
        )  # 32*32
        self.mpool1 = nn.MaxPool3d(kernel_size=2, stride=2, padding=0)  # 16*16
        ...
        self.mpool2 = nn.Sequential(
            nn.BatchNorm3d(1024),
            nn.ReLU(inplace=True),
            nn.AvgPool3d(kernel_size=4, stride=1)
        )
...
class ResidualAttentionModel_92_32input_update(nn.Module):
    ...
    def __init__(self):
        ...
        self.attention_module1 = AttentionModule_stage1_cifar(128, 128, size1=(32, 32, 32), size2=(16, 16, 16))  # 32*32
        self.residual_block2 = ResidualBlock(128, 256, 2)  # 16*16
        self.attention_module2 = AttentionModule_stage2_cifar(256, 256, size=(16, 16, 16))  # 16*16
        self.attention_module2_2 = AttentionModule_stage2_cifar(256, 256, size=(16, 16, 16))  # 16*16 # tbq add
        self.residual_block3 = ResidualBlock(256, 512, 2)  # 4*4
